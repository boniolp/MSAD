...
# python3 train_deep_model.py --path=data/TSB_512/ --split=0.7 --file=experiments/unsupervised_splits/unsupervised_testsize_1_split_0.csv --model=sit --params=models/configuration/sit_stem_original.json --batch=256 --epochs=100 --eval-true
